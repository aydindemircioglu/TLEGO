...
Please read the "../LGPL.txt" license file before using the BudgetedSVM toolbox.
...
we have added the following changes:
	- The software is no longer published under GPL v3 license, instead we publish
		BudgetedSVM under less restrictive LGPL v3 license.
